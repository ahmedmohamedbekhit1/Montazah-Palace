...
<header>
    <div class="header-content">
        ...
        <nav>
            <ul>
                <li> <a href="Place.php">Home</a></li>
                <li><a href="about.php">About</a></li>
                <li><a href="events.php">Virtual Tours</a></li>
                ...
                <li>
                    <div class="cta-container">
                        ...
                        <a href="logout.php" class="cta-button" style="display:none">Logout</a>
                    </div>
                </li>
                ...
                <li> <label class="theme-switch">
                        ...
                        <div class="theme-switch__container" id="">
...
<div id="drawer" class="drawer">
    ...
    <a href="Place.php">Home</a><br>
    <a href="about.php">About</a><br>
    <a href="events.php">Virtual Tours</a><br>
    <a href="visit.php">Visit Us</a><br>
    <a href="media.php">Media Gallery</a><br>
    <div class="cta-container">
        <a onclick="showLoginForm()" class="cta-button" title="Login">Login</a>
        <a onclick="showRegisterForm()" class="cta-button" title="regisrter">Regisrter</a>
        <a href="logout.php" class="cta-button" style="display:none">Logout</a>
    ...
    <label class="theme-switch">
        <input type="checkbox" class="theme-switch__checkbox" id="darkModeToggle2" />
